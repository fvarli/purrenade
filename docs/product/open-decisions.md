...
| **OPS-3** | **CI/CD design.** Deployment is manual today. The next infrastructure milestone; the invariants the automation must preserve are already written down. | [`../production/deployment.md`](../production/deployment.md) §6 · `purrenade-api/docs/production/deployment.md` §6 |
