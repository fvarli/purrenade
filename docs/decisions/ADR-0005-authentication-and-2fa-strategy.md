...
documented in `purrenade-api/docs/architecture/auth-architecture.md` (API side) and [`../architecture/bff-and-session.md`](../architecture/bff-and-session.md) (browser side).
